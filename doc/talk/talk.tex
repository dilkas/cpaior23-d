  ...
  \begin{block}{Setup}
    \begin{columns}
      \begin{column}{0.70\linewidth}
        ...
        Partial formula:
        \structure{$(\neg x_{5} \lor x_{2} \lor x_{1}) \land (x_{5} \lor \structure{\mathord{?}} \lor \mathord{?})$}.
      \end{column}
  ...
  \begin{block}{Observations}
    \begin{itemize}
      ...
      \item The running time of \textsc{DPMC} peaks at a higher density and
            ...
            \end{itemize}
      \item \textsc{miniC2D} seems to be best at low density high primal
            treewidth instances
    \end{itemize}
  \end{block}
