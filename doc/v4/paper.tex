...
\spnewtheorem{experiment}{Experiment}{\bfseries}{\rmfamily}
...
\begin{abstract}
  ...
  weights.
\end{abstract}
% TODO: update the abstract, the introduction, and the conclusions to reflect the new info
% TODO: incorporate thesis corrections
% TODO: emphasise the potential for a portfolio (CPAIOR cares about that)
% TODO: take reviewer feedback into consideration
% TODO: use a grammarly on the new paragraphs
...
\begin{figure}[t]
  ...
  {Visualisations of the data from \cref{exp:density}. The top-left plot shows
    ...
    provided by ESA \protect{\cite{DBLP:conf/gecco/PushakH20}} (with shaded
    regions showing \SI{95}{\percent} confidence
    intervals).}\label{fig:treewidth}
\end{figure}
...
\Cref{fig:real} shows the best-performing algorithm for various combinations of
