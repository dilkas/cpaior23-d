...
\title{On the empirical scaling of running time of cachet for solving random instances with mu = 2.2}
...
of the running time of cachet for solving random instances with mu = 2.2.
...
instances ($n\leq30$) and \emph{challenge} or
\emph{test} instances ($n>30$) with 1837
and 3263 instances, respectively. The
...
% cachet solving random instances with mu = 2.2.
% \begin{figure*}[tb]
% \begin{centering}
...
cachet solving the set of random instances with mu = 2.2
with $22\leq n\leq 30$ variables, and are challenged by the medians of
the \randomizedAlgorithm{per-instance median}
running times of $30< n \leq 39$ variables.}
\end{figure}
...
predictions and observed running times on random instances with mu = 2.2.
...
running time predictions and observed running times on random instances with mu = 2.2.
...
behaviour of cachet on random instances with mu = 2.2. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
