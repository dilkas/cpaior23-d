...
\title{On the empirical scaling of running time of cachet for solving random instances with mu = 2.8}
...
of the running time of cachet for solving random instances with mu = 2.8.
...
% cachet solving random instances with mu = 2.8.
% \begin{figure*}[tb]
% \begin{centering}
...
cachet solving the set of random instances with mu = 2.8
...
behaviour of cachet on random instances with mu = 2.8. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
