...
\title{On the empirical scaling of running time of d4 for solving random instances with mu = 1.9}
...
of the running time of d4 for solving random instances with mu = 1.9.
...
4263 instances of different sizes \randomizedAlgorithm{with
...
\emph{test} instances ($n>26$) with 1517
and 2746 instances, respectively. The
...
% d4 solving random instances with mu = 1.9.
% \begin{figure*}[tb]
% \begin{centering}
...
behaviour of d4 on random instances with mu = 1.9. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
