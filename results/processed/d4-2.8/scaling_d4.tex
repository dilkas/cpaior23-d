...
\title{On the empirical scaling of running time of d4 for solving random instances with mu = 2.8}
...
of the running time of d4 for solving random instances with mu = 2.8.
...
5099 instances of different sizes \randomizedAlgorithm{with
...
and 3345 instances, respectively. The
...
% d4 solving random instances with mu = 2.8.
% \begin{figure*}[tb]
% \begin{centering}
...
d4 solving the set of random instances with mu = 2.8
...
behaviour of d4 on random instances with mu = 2.8. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
