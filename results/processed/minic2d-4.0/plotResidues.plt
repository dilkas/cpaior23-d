...
set arrow from 42,graph 0 to 42,graph 1 nohead lc 'black' dt 3
...
plot 'gnuplotResidueFile.txt' using 1:3:4 with filledcurves lc "magenta" notitle,  \
'gnuplotResidueFile.txt' using 1:6:7 with filledcurves lc "cyan" notitle,  \
