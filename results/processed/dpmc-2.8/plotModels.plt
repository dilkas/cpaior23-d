...
set xrange[27/1.1:44*1.1]
set yrange[0.63/10:500.0*10]
...
set arrow from 35,graph 0 to 35,graph 1 nohead lc 'black' dt 3 lw 2 
...
0.0003629610015947614*1.3576257977424595**x lc "magenta" title 'Exp Model', \
2.678725865065288e-15*x**10.21728927854565 lc "cyan" title 'Poly Model', \
