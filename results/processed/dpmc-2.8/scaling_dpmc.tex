...
\title{On the empirical scaling of running time of dpmc for solving random instances with mu = 2.8}
...
of the running time of dpmc for solving random instances with mu = 2.8.
...
and 3344 instances, respectively. The
...
% dpmc solving random instances with mu = 2.8.
% \begin{figure*}[tb]
% \begin{centering}
...
dpmc solving the set of random instances with mu = 2.8
...
behaviour of dpmc on random instances with mu = 2.8. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
