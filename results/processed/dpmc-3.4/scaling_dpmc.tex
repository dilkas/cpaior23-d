...
\title{On the empirical scaling of running time of dpmc for solving random instances with mu = 3.4}
...
of the running time of dpmc for solving random instances with mu = 3.4.
...
and 3355 instances, respectively. The
...
% dpmc solving random instances with mu = 3.4.
% \begin{figure*}[tb]
% \begin{centering}
...
dpmc solving the set of random instances with mu = 3.4
...
behaviour of dpmc on random instances with mu = 3.4. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
