...
set xrange[36/1.1:51*1.1]
set yrange[0.01/10:7.49*10]
...
set arrow from 44,graph 0 to 44,graph 1 nohead lc 'black' dt 3 lw 2 
...
0.019980996536462334*1.0000210010154205**x lc "magenta" title 'Exp Model', \
0.019933079700509504*x**0.0008785262598394183 lc "cyan" title 'Poly Model', \
