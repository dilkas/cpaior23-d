...
\title{On the empirical scaling of running time of cachet for solving random instances with mu = 4.3}
...
of the running time of cachet for solving random instances with mu = 4.3.
...
% cachet solving random instances with mu = 4.3.
% \begin{figure*}[tb]
% \begin{centering}
...
cachet solving the set of random instances with mu = 4.3
...
predictions and observed running times on random instances with mu = 4.3.
...
running time predictions and observed running times on random instances with mu = 4.3.
...
behaviour of cachet on random instances with mu = 4.3. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
