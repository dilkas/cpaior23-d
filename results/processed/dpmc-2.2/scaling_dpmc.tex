...
\title{On the empirical scaling of running time of dpmc for solving random instances with mu = 2.2}
...
of the running time of dpmc for solving random instances with mu = 2.2.
...
5088 instances of different sizes \randomizedAlgorithm{with
...
and 3251 instances, respectively. The
...
% dpmc solving random instances with mu = 2.2.
% \begin{figure*}[tb]
% \begin{centering}
...
dpmc solving the set of random instances with mu = 2.2
...
behaviour of dpmc on random instances with mu = 2.2. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
