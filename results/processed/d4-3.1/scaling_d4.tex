...
\title{On the empirical scaling of running time of d4 for solving random instances with mu = 3.1}
...
of the running time of d4 for solving random instances with mu = 3.1.
...
% d4 solving random instances with mu = 3.1.
% \begin{figure*}[tb]
% \begin{centering}
...
d4 solving the set of random instances with mu = 3.1
...
behaviour of d4 on random instances with mu = 3.1. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
