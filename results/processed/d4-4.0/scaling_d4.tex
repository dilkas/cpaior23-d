...
\title{On the empirical scaling of running time of d4 for solving random instances with mu = 4.0}
...
of the running time of d4 for solving random instances with mu = 4.0.
...
% d4 solving random instances with mu = 4.0.
% \begin{figure*}[tb]
% \begin{centering}
...
d4 solving the set of random instances with mu = 4.0
...
behaviour of d4 on random instances with mu = 4.0. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
