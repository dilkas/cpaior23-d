...
\title{On the empirical scaling of running time of dpmc for solving random instances with mu = 1.3}
...
of the running time of dpmc for solving random instances with mu = 1.3.
...
\randomizedAlgorithm{%
Since dpmc is a randomized algorithm, we analyzed the per-instance
...
% dpmc solving random instances with mu = 1.3.
% \begin{figure*}[tb]
% \begin{centering}
...
dpmc solving the set of random instances with mu = 1.3
...
behaviour of dpmc on random instances with mu = 1.3. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
