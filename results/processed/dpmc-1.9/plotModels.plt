...
set xrange[19/1.1:36*1.1]
set yrange[0.18/10:500.0*10]
...
set arrow from 27,graph 0 to 27,graph 1 nohead lc 'black' dt 3 lw 2 
...
5.220946736992151e-05*1.604312273485951**x lc "magenta" title 'Exp Model', \
1.3049143326899696e-16*x**11.976047646127881 lc "cyan" title 'Poly Model', \
