...
\title{On the empirical scaling of running time of cachet for solving random instances with mu = 2.5}
...
of the running time of cachet for solving random instances with mu = 2.5.
...
instances ($n\leq33$) and \emph{challenge} or
\emph{test} instances ($n>33$) with 1958
and 3142 instances, respectively. The
...
% cachet solving random instances with mu = 2.5.
% \begin{figure*}[tb]
% \begin{centering}
...
cachet solving the set of random instances with mu = 2.5
with $24\leq n\leq 33$ variables, and are challenged by the medians of
the \randomizedAlgorithm{per-instance median}
running times of $33< n \leq 42$ variables.}
\end{figure}
...
predictions and observed running times on random instances with mu = 2.5.
...
running time predictions and observed running times on random instances with mu = 2.5.
...
behaviour of cachet on random instances with mu = 2.5. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
