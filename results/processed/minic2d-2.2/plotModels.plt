...
set xrange[22/1.1:39*1.1]
set yrange[0.5/10:209.02*10]
...
set arrow from 30,graph 0 to 30,graph 1 nohead lc 'black' dt 3 lw 2 
...
0.0022878778552230376*1.2721402528143757**x lc "magenta" title 'Exp Model', \
4.876539523467263e-10*x**6.635026183870195 lc "cyan" title 'Poly Model', \
