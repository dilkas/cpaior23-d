...
\title{On the empirical scaling of running time of cachet for solving random instances with mu = 1.0}
...
of the running time of cachet for solving random instances with mu = 1.0.
...
% cachet solving random instances with mu = 1.0.
% \begin{figure*}[tb]
% \begin{centering}
...
cachet solving the set of random instances with mu = 1.0
...
behaviour of cachet on random instances with mu = 1.0. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
