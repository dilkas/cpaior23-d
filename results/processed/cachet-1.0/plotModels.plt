...
set xrange[7/1.1:21*1.1]
set yrange[0.01/10:2.88*10]
...
set arrow from 13,graph 0 to 13,graph 1 nohead lc 'black' dt 3 lw 2 
...
0.0036100773465060207*1.3093352189354721**x lc "magenta" title 'Exp Model', \
5.628123577837929e-05*x**2.9883164243984766 lc "cyan" title 'Poly Model', \
