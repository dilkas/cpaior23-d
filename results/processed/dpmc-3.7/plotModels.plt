...
set xrange[34/1.1:49*1.1]
set yrange[0.19/10:500.0*10]
...
set arrow from 41,graph 0 to 41,graph 1 nohead lc 'black' dt 3 lw 2 
...
0.00033950254296391573*1.2671391266211556**x lc "magenta" title 'Exp Model', \
8.075430888832337e-15*x**9.201154476235388 lc "cyan" title 'Poly Model', \
