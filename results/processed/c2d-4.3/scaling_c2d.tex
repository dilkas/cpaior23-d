...
\title{On the empirical scaling of running time of c2d for solving random instances with mu = 4.3}
...
of the running time of c2d for solving random instances with mu = 4.3.
...
% c2d solving random instances with mu = 4.3.
% \begin{figure*}[tb]
% \begin{centering}
...
c2d solving the set of random instances with mu = 4.3
...
behaviour of c2d on random instances with mu = 4.3. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
