...
set xrange[24/1.1:42*1.1]
set yrange[0.65/10:115.19*10]
...
set arrow from 33,graph 0 to 33,graph 1 nohead lc 'black' dt 3 lw 2 
...
0.004398969047080702*1.2418303625209914**x lc "magenta" title 'Exp Model', \
4.3816574034272253e-10*x**6.653069594079625 lc "cyan" title 'Poly Model', \
