...
\title{On the empirical scaling of running time of c2d for solving random instances with mu = 2.5}
...
of the running time of c2d for solving random instances with mu = 2.5.
...
5091 instances of different sizes \randomizedAlgorithm{with
...
and 3133 instances, respectively. The
...
% c2d solving random instances with mu = 2.5.
% \begin{figure*}[tb]
% \begin{centering}
...
c2d solving the set of random instances with mu = 2.5
...
behaviour of c2d on random instances with mu = 2.5. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
