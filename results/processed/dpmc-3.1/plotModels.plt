...
set xrange[30/1.1:46*1.1]
set yrange[0.3/10:500.0*10]
...
set arrow from 37,graph 0 to 37,graph 1 nohead lc 'black' dt 3 lw 2 
...
0.0002779291866273821*1.3293242405676926**x lc "magenta" title 'Exp Model', \
1.7037296737175986e-15*x**10.066349472090224 lc "cyan" title 'Poly Model', \
