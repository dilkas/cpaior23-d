...
\title{On the empirical scaling of running time of d4 for solving random instances with mu = 1.6}
...
of the running time of d4 for solving random instances with mu = 1.6.
...
4566 instances of different sizes \randomizedAlgorithm{with
...
and 3116 instances, respectively. The
...
% d4 solving random instances with mu = 1.6.
% \begin{figure*}[tb]
% \begin{centering}
...
behaviour of d4 on random instances with mu = 1.6. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
