...
\title{On the empirical scaling of running time of d4 for solving random instances with mu = 2.2}
...
of the running time of d4 for solving random instances with mu = 2.2.
...
4623 instances of different sizes \randomizedAlgorithm{with
...
\emph{test} instances ($n>30$) with 1835
and 2788 instances, respectively. The
...
% d4 solving random instances with mu = 2.2.
% \begin{figure*}[tb]
% \begin{centering}
...
d4 solving the set of random instances with mu = 2.2
...
behaviour of d4 on random instances with mu = 2.2. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
