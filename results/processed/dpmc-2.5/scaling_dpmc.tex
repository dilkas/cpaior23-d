...
\title{On the empirical scaling of running time of dpmc for solving random instances with mu = 2.5}
...
of the running time of dpmc for solving random instances with mu = 2.5.
...
5098 instances of different sizes \randomizedAlgorithm{with
...
and 3140 instances, respectively. The
...
% dpmc solving random instances with mu = 2.5.
% \begin{figure*}[tb]
% \begin{centering}
...
dpmc solving the set of random instances with mu = 2.5
...
behaviour of dpmc on random instances with mu = 2.5. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
