...
\title{On the empirical scaling of running time of d4 for solving random instances with mu = 2.5}
...
of the running time of d4 for solving random instances with mu = 2.5.
...
5035 instances of different sizes \randomizedAlgorithm{with
...
\emph{test} instances ($n>33$) with 1957
and 3078 instances, respectively. The
...
% d4 solving random instances with mu = 2.5.
% \begin{figure*}[tb]
% \begin{centering}
...
d4 solving the set of random instances with mu = 2.5
...
behaviour of d4 on random instances with mu = 2.5. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
