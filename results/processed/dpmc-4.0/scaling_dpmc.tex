...
\title{On the empirical scaling of running time of dpmc for solving random instances with mu = 4.0}
...
of the running time of dpmc for solving random instances with mu = 4.0.
...
% dpmc solving random instances with mu = 4.0.
% \begin{figure*}[tb]
% \begin{centering}
...
dpmc solving the set of random instances with mu = 4.0
...
behaviour of dpmc on random instances with mu = 4.0. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
