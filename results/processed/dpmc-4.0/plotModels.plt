...
set arrow from 42,graph 0 to 42,graph 1 nohead lc 'black' dt 3 lw 2 
...
3.8787296765081394e-05*1.3159460241326575**x lc "magenta" title 'Exp Model', \
4.011697483859234e-18*x**11.08472300413996 lc "cyan" title 'Poly Model', \
