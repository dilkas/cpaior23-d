...
set xrange[11/1.1:27*1.1]
set yrange[0.26/10:212.21*10]
...
set arrow from 18,graph 0 to 18,graph 1 nohead lc 'black' dt 3 lw 2 
...
0.0046600237686286105*1.4770994520116782**x lc "magenta" title 'Exp Model', \
4.692940163888407e-08*x**6.40723720029996 lc "cyan" title 'Poly Model', \
