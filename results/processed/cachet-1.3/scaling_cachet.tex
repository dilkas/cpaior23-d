...
\title{On the empirical scaling of running time of cachet for solving random instances with mu = 1.3}
...
of the running time of cachet for solving random instances with mu = 1.3.
...
instances ($n\leq18$) and \emph{challenge} or
\emph{test} instances ($n>18$) with 1706
and 3394 instances, respectively. The
...
% cachet solving random instances with mu = 1.3.
% \begin{figure*}[tb]
% \begin{centering}
...
cachet solving the set of random instances with mu = 1.3
with $11\leq n\leq 18$ variables, and are challenged by the medians of
the \randomizedAlgorithm{per-instance median}
running times of $18< n \leq 27$ variables.}
\end{figure}
...
predictions and observed running times on random instances with mu = 1.3.
...
running time predictions and observed running times on random instances with mu = 1.3.
...
behaviour of cachet on random instances with mu = 1.3. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
