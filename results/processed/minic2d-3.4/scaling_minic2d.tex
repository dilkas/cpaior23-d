...
\title{On the empirical scaling of running time of minic2d for solving random instances with mu = 3.4}
...
of the running time of minic2d for solving random instances with mu = 3.4.
...
% minic2d solving random instances with mu = 3.4.
% \begin{figure*}[tb]
% \begin{centering}
...
minic2d solving the set of random instances with mu = 3.4
...
behaviour of minic2d on random instances with mu = 3.4. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
