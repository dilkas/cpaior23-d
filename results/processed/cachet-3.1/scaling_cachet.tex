...
\title{On the empirical scaling of running time of cachet for solving random instances with mu = 3.1}
...
of the running time of cachet for solving random instances with mu = 3.1.
...
% cachet solving random instances with mu = 3.1.
% \begin{figure*}[tb]
% \begin{centering}
...
cachet solving the set of random instances with mu = 3.1
...
predictions and observed running times on random instances with mu = 3.1.
...
running time predictions and observed running times on random instances with mu = 3.1.
...
behaviour of cachet on random instances with mu = 3.1. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
