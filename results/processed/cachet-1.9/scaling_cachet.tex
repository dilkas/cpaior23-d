...
\title{On the empirical scaling of running time of cachet for solving random instances with mu = 1.9}
...
of the running time of cachet for solving random instances with mu = 1.9.
...
instances ($n\leq27$) and \emph{challenge} or
\emph{test} instances ($n>27$) with 1980
and 3120 instances, respectively. The
...
% cachet solving random instances with mu = 1.9.
% \begin{figure*}[tb]
% \begin{centering}
...
cachet solving the set of random instances with mu = 1.9
with $19\leq n\leq 27$ variables, and are challenged by the medians of
the \randomizedAlgorithm{per-instance median}
running times of $27< n \leq 36$ variables.}
\end{figure}
...
predictions and observed running times on random instances with mu = 1.9.
...
running time predictions and observed running times on random instances with mu = 1.9.
...
behaviour of cachet on random instances with mu = 1.9. We found
the Exp model tends to under-estimate the data, and the Poly model tends to under-estimate the data.
