...
set xrange[200/1.1:2545110*1.1]
set yrange[0.0005/10:3600.0*10]
...
set arrow from 757881,graph 0 to 757881,graph 1 nohead lc 'black' dt 3 lw 2 
...
x*0 + 3600.0 lw 2 dt 2 lc 'black' title 'Running Time Cutoff', \
...
4.120940750627154*1.0000052521877367**x lc "magenta" title 'Exp Model', \
8.185079218302017e-11*x**2.089113746878411 lc "cyan" title 'Poly Model', \
